...
// import AddInterviewerModal from "@/components/onboard/AddInterviewerModal";
...
const update = (props: Props) => {
  ...
  const [formData, setFormData] = useState<jobPostI>({
    "job-title": "done",
    "job-description": "ok",
    "interview-timezone": "Canada / Torronto",
    "salary-range": "230902",
  ...
  const handleSubmit = (e:MouseEvent<HTMLButtonElement>) => {
    ...
    toast.addToast('success','Job Post updated successfully')
