...
const AppFooter = () => {
  return (
    <footer className="bg-brand-darkGreen">
      <div className="max-w-[79.1875rem] mx-auto px-5 text-white">
        <div className="flex flex-col md:flex-row gap-y-3 justify-between items-center py-4 md:py-9">
          <h1 className="font-montserrat font-extrabold text-28 md:text-40">
            NoHR.ai
          </h1>
          ...
          <div className="w-full md:w-72 flex justify-between items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <a href="https://www.facebook.com/nohrai/" target="_blank">
                <svg
                  className="fill-white hover:fill-brand-yellow"
                  width="32"
                  height="32"
                  viewBox="0 0 32 32"
              ...
              <a href="https://www.instagram.com/nohr.ai/" target="_blank">
                <svg
                  className="fill-white hover:fill-brand-yellow"
                  width="32"
                  height="32"
              ...
              <a href="https://www.linkedin.com/company/nohr-ai/" target="_blank">
                <svg
                  className="fill-white hover:fill-brand-yellow"
                  width="32"
                  height="32"
              ...
              <a href="https://twitter.com/nohr_ai" target="_blank">
                <svg
                  className="fill-white hover:fill-brand-yellow"
                  width="32"
                  height="32"
      ...
      <div className="max-w-[79.1875rem] mx-auto px-5 text-white font-poppins pt-6 md:pt-14 pb-12 md:pb-28">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10">
          <div>
            ...
            <div className="flex flex-col text-sm md:text-base gap-4 mt-5">
              <div className="flex gap-4 group">
                <a href="#">
                  <svg
                    className="fill-white group-hover:fill-brand-yellow"
                    width="31"
                    height="30"
                    viewBox="0 0 31 30"
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <div>
                  <p className="text-brand-gray-200">Office Locations</p>
                  <a href="#" className="group-hover:text-brand-yellow">
                    Bangalore | Ahmedabad
                  </a>
                </div>
              </div>
              ...
              <div className="flex gap-4 group">
                ...
                <div>
                  <p className="text-brand-gray-200">Email</p>
                  <a href="mailto:contact@nohr.com" className="group-hover:text-brand-yellow">
                    contact@nohr.com
                  </a>
                </div>
              </div>
              <div className="flex gap-4 group">
                ...
                <div>
                  <p className="text-brand-gray-200">LinkedIn</p>
                  <Link
                    href="https://www.linkedin.com/company/nohr-ai"
                    target="_blank"
                    className="group-hover:text-brand-yellow"
                  >
                    @nohr-ai
                  </Link>
                </div>
          ...
          <div className="md:mx-auto">
            ...
            <div className="flex flex-col text-sm md:text-base gap-4 mt-5">
              ...
              <Link href="/terms-of-service" className="hover:text-brand-yellow">
                Terms Of Service
              </Link>
          ...
          <div>
            ...
            <input
              ...
              className="w-full md:max-w-sm rounded-xl bg-brand-gray-400 border-none outline-brand-yellow text-sm md:text-base py-3 px-4 mt-3"
            />

            <button
              type="submit"
              id="email"
              className="w-full md:w-40 text-center text-sm md:text-base font-semibold bg-brand-yellow rounded-xl hover:opacity-80 hover:text-brand-green py-3 px-9 mt-3 md:mt-6"
            >
              Subscribe
            </button>
          </div>
      ...
      <div className="bg-[#185932] text-center text-white py-4">
        <p className="font-poppins font-medium text-sm">
          © Copyright 2023, All Rights Reserved | NoHR.ai
        </p>
      </div>
    </footer>
  );
